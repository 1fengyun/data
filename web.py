...
table_1={"models":["BMW M4","AUDI A4L"],
         "engine":["3.0T twin turbo inline 6","2.0T four cylinders"],
         "maximum horsepower":["480-510 horsepower","190-265 horsepower"],
         "100 km/h acceleration":["3.5-4.2 seconds","6.6-8.2 seconds"],
         "Battery life":["550-650km","700-900km"],
         "chassis stability":[10,8]}
st.table(table_1)#加入表格
